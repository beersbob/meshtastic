...
2. Double click the reset button on your device (this will put it into bootloader mode). The tiny reset button is next to the USB connector on the RAK base board.
...
5. From the firmware download, drag the appropriate firmware file(`firmware-DEVICE_NAME-vx.x.x-xxxxxxx.uf2`) onto this drive.
